...
public class ListarValidacionesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView Personas_Validar = view.findViewById(R.id.rv_personas_validar);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        hogares_validar_adapter hogares_validar_adapter = new hogares_validar_adapter(getContext());
